...
**Формат:**
`!cmd lim (add) <кол-во запросов> <интервал в секундах> <команды>`
...
**Формат:**
`!cmd lim set <кол-во запросов> <интервал в секундах> <команды>`
...
**Пример:**
```text
!cmd lim set 5 120 !hello,!uptime
```
